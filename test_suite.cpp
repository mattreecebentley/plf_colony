// TODO: double-check that reverse-iterator semantics match vector
...
//#include "SDL.h" // Install and use SDL2 (libsdl.org) for more accurate timing - regular STL timing may only be accurate to around 15ms, regardless of function used (including high_resolution_clock), depending on the OS and compiler.
